    ...
    <section id="for-artists" className="relative py-24 md:py-32 px-6 bg-[#0E1712] border-y border-emerald/20 scroll-mt-16">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <AnimatedText
          ...
          text="Once you're on the platform, you'll be able to see exactly where your music was played, how many times, and an evidence-based estimate of what you're owed, which your licensed CMO uses to pay you."
        />
