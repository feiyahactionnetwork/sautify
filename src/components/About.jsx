    ...
    <section id="about" className="py-24 md:py-32 px-6 bg-ink scroll-mt-16">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <AnimatedText
          ...
          text="Sautify was founded in Nairobi by a team that saw firsthand how Kenya's music artists were being shortchanged by a system that had no data. We're building the infrastructure that makes royalty attribution transparent, auditable, and fair, starting with Kenya."
        />
